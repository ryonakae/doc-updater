...
description: セッション中の失敗・修正・試行錯誤を振り返って分析し、再発防止策を doc-updater エージェント経由で AGENTS.md や CLAUDE.md に反映する。「振り返って」「今のセッションから学んで」「同じミスを防いで」「やり取りを反映して」「反省点を残して」「教訓を記録して」などのリクエストがあった時に使用する。
---
...
書き出したら、doc-updater サブエージェント（モデルは必ず haiku を使う）に以下を依頼する:
